...
_G.packer_plugins = {
  ...
  ["cmp-nvim-ultisnips"] = {
    loaded = true,
    path = "/home/krzys/.local/share/nvim/site/pack/packer/start/cmp-nvim-ultisnips",
  ...
  ["nvim-cmp"] = {
    after = { "nvim-lspconfig", "ultisnips" },
  ...
  ultisnips = {
    after_files = { "/home/krzys/.local/share/nvim/site/pack/packer/opt/ultisnips/after/plugin/UltiSnips_after.vim" },
    load_after = {},
    loaded = true,
    needs_bufread = true,
    path = "/home/krzys/.local/share/nvim/site/pack/packer/opt/ultisnips",
  ...
  ["vim-snippets"] = {
    loaded = true,
    path = "/home/krzys/.local/share/nvim/site/pack/packer/start/vim-snippets",
